...
class Widgets:
    def __init__(self, parent, controller):
        ...
        Label(frame, text='Seleccionar un estudiante para registrar o modificar nota').grid(row=4, column=0,columnspan=4, sticky='we', padx=120, pady=(10,0))
        ...
        Label(frame, text='Seleccionar un estudiante para modificar Datos (No Cédula de identidad)').grid(row=6, column=0, columnspan=4, sticky='we', padx=80, pady=(10,0))
        ...
        Label(frame, text='Seleccionar un estudiante para retirarlo del registro').grid(row=8, column=0,columnspan=4, sticky='we', padx=150, pady=(10,0))
        ...
        Label(frame, text='Seleccionar un estudiante para descargar en EXCEL las notas de la sección ').grid(row=10, column=0, columnspan=4, sticky='we', padx=80, pady=(10,0))
        ...
        self.tree.column('col0', width=70)
