...
def create_widgets(self, master, cedula_estudiante=None):
    ...
    rowheight=25, # Ajusta la altura de la fila si es necesario
    fieldbackground="#FFFFFF" # Fondo blanco para que la línea se vea mejor
)
    ...
    self.tree.column('col4', width=70)
    self.tree.column('col5', width=40)
    self.tree.column('col6', width=40)
    self.tree.column('col7', width=40)
    self.tree.column('col8', width=40)
    self.tree.column('col9', width=40)
    self.tree.column('col10', width=40)
    self.tree.column('col11', width=40)
