...
def create_widgets(self, master, cedula_estudiante=None):
    ...
    self.tree = ttk.Treeview(self, columns=('numeracion', 'col1', 'col2','col3','col4','col5','col6','col7','col8','col9','col10','col11','col12','col13','col14','col15'), show='headings')
    ...
    self.tree.heading('numeracion', text='N°', anchor='center')
    ...
    self.tree.column('numeracion', width=40, anchor='center')
