...
def create_widgets(self, master, cedula_estudiante=None):
    ...
    self.tree.heading('col4', text='Apellido', anchor='center')
    self.tree.heading('col5', text='Ev1', anchor='center')
    self.tree.heading('col6', text='Ev2', anchor='center')
    self.tree.heading('col7', text='Ev3', anchor='center')
    self.tree.heading('col8', text='Ev4', anchor='center')
    self.tree.heading('col9', text='Ev5', anchor='center')
    self.tree.heading('col10', text='Ev6', anchor='center')
    self.tree.heading('col11', text='Ev7', anchor='center')
    self.tree.heading('col12', text='Ev8', anchor='center')
    self.tree.heading('col13', text='Ev9', anchor='center')
    self.tree.heading('col14', text='Ev10', anchor='center')
    ...
    self.tree.column('col3', width=90)
    self.tree.column('col4', width=90)
    ...
    self.tree.column('col14', width=50)
    self.tree.column('col15', width=80)
    self.tree.column('col16', width=80)
...
#     # Treeview
#     self.tree = ttk.Treeview(self, columns=('col1', 'col2','col3','col4','col5','col6','col7','col8','col9','col10','col11','col12','col13','col14','col15'), show='headings')
#     self.tree.grid(row=0, column=1, rowspan=2, padx=10, pady=10, sticky="nsew")
...
#     self.tree.heading('col4', text='Eval 1', anchor='center')
#     self.tree.heading('col5', text='Eval 2', anchor='center')
#     self.tree.heading('col6', text='Eval 3', anchor='center')
#     self.tree.heading('col7', text='Eval 4', anchor='center')
#     self.tree.heading('col8', text='Eval 5', anchor='center')
#     self.tree.heading('col9', text='Eval 6', anchor='center')
#     self.tree.heading('col10', text='Eval 7', anchor='center')
#     self.tree.heading('col11', text='Eval 8', anchor='center')
#     self.tree.heading('col12', text='Eval 9', anchor='center')
#     self.tree.heading('col13', text='Eval 10', anchor='center')
#     self.tree.heading('col14', text='Promedio', anchor='center')
#     self.tree.heading('col15', text='TOTAL', anchor='center')
...
#     self.tree.column('col11', width=60)
#     self.tree.column('col12', width=60)
#     self.tree.column('col13', width=60)
#     self.tree.column('col14', width=80)
#     self.tree.column('col15', width=80)
