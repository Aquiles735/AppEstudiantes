...
class Control:
    ...
    def get_estudiantes(self): 
        ...
        # Consulta SQL modificada para ordenar los resultados
        # Se ordena primero por 'seccion' y luego por 'cedula_estudiante'
        # 'DESC' indica un orden descendente (decreciente)
